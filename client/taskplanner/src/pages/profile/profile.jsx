...
export default function ProfilePage() {
    ...
    useEffect(() => {
        async function fetchTasks() {
            try {
                ...
                const createdRes = await fetch(`https://task-planner-api-bmko.onrender.com/api/tasks/created/${userData.id}`);
                if (createdRes.ok) {
                ...
                const assignedRes = await fetch(`https://task-planner-api-bmko.onrender.com/api/tasks/assigned/${userData.id}`);
                if (assignedRes.ok) {
    ...
    const handleDeleteTask = async (taskId) => {
        try {
            const response = await fetch(`https://task-planner-api-bmko.onrender.com/api/tasks/delete/${taskId}`, {
                method: 'DELETE'
            });
            if (response.ok) {
