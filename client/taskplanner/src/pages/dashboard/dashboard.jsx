    ...
    useEffect(() => {
        async function loadWeeklyTasks() {
            try {
                ...
                const response = await fetch(`https://task-planner-api-bmko.onrender.com/api/tasks?startDate=${startDate}&endDate=${endDate}`);
    ...
    async function loadFilteredTasks(filterType) {
        ...
        try {
            const response = await fetch(
                `https://task-planner-api-bmko.onrender.com/api/tasks?startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`
            );
